...
images_n_vids_path = "D:\\plate-recognition-yolo-master\\plate-recognition-yolo-2\\dataset\\sample"
image_path = os.path.join(images_n_vids_path, "plate_2.jpg")
video_path = os.path.join(images_n_vids_path, "video.mp4")

savepath = "D:\\plate-recognition-yolo-master\\plate-recognition-yolo-2\\output"
